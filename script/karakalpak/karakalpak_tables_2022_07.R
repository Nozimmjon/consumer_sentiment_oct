...
karakalpak_input_02 %>%
  ...
  my_theme_gt() %>% 
  cols_width(everything() ~ px(180)) %>% 
  gtsave('4_savol.png', path = here("results", "tables", "Karakalpak"))
...
karakalpak_input_02 %>%
  ...
  my_theme_gt() %>% 
  cols_width(everything() ~ px(180)) %>% 
  gtsave('6_savol.png', path = here("results", "tables", "Karakalpak"))

#table 7

# table_7 <- Karakalpak_input_02 %>% add_count(district) %>% 
...
# 
# write_xlsx(table_7, "muammolar_Karakalpak.xlsx")
...
karakalpak_input_02 %>%
  ...
  my_theme_gt() %>% 
  gtsave('mahalliy_organ.png', path = here("results", "tables", "Karakalpak"))
...
karakalpak_input_02 %>%
  ...
  cols_width(everything() ~ px(120)) %>%
  my_theme_gt() %>%
  gtsave('hokim_yordamchisi.png', path = here("results", "tables", "Karakalpak"))
...
karakalpak_input_02 %>%
  ...
  cols_width(everything() ~ px(120)) %>%
  my_theme_gt() %>%
  gtsave('yoshlar_yetakchisi.png', path = here("results", "tables", "Karakalpak"))
...
karakalpak_input_02 %>%
  ...
  cols_width(everything() ~ px(120)) %>%
  my_theme_gt() %>%
  gtsave('ayollar_yetakchisi.png', path = here("results", "tables", "Karakalpak"))
...
karakalpak_input_02 %>% 
  ...
  my_theme_gt() %>% 
  gtsave('formality.png', path = here("results", "tables", "Karakalpak"))    
