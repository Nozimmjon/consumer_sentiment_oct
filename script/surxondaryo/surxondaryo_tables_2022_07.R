...
surxondaryo_input_02 %>%
  ...
  cols_width(everything() ~ px(120)) %>%
  my_theme_gt() %>%
  gtsave('hokim_yordamchisi.png', path = here("results", "tables", "surxondaryo"))
...
surxondaryo_input_02 %>%
  ...
  cols_width(everything() ~ px(120)) %>%
  my_theme_gt() %>%
  gtsave('yoshlar_yetakchisi.png', path = here("results", "tables", "surxondaryo"))
...
surxondaryo_input_02 %>%
  ...
  cols_width(everything() ~ px(120)) %>%
  my_theme_gt() %>%
  gtsave('ayollar_yetakchisi.png', path = here("results", "tables", "surxondaryo"))
